 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80 * 4, 80 * 4, 400, 407.2 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 10, 250 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.093 // (mm) Distance from real junction edge
