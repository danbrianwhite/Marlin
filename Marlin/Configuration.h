...
#define CUSTOM_MACHINE_NAME "Tiny-M"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  49.34
    #define DEFAULT_Ki   5.26
    #define DEFAULT_Kd 115.70
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 69.24
  #define DEFAULT_bedKi 3.07
  #define DEFAULT_bedKd 10641.38
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80 * 1, 80 * 1, 322.5 * 1, 605.5 * 1 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 5000, 5000, 10, 350 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 7575, 7575, 200, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 10, -5.06 }
...
#define Y_MIN_POS -6
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE + 0.6)
